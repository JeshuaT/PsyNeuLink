...
class Composition(Composition_Base, metaclass=ComponentsMeta):
    ...
    show_graph_attributes : dict : None
        specifies state of how the Composition is displayed when its `show_graph <ShowGraph.show_graph>` method
    ...
    def _build_predicted_inputs_dict(self, predicted_input):
        inputs = {}
        # ASSUMPTION: input_ports[0] is NOT a feature and input_ports[1:] are state
    ...
    #  They could be different in the future depending on new state (ex. if we introduce recurrent compositions)
