...
class CompositionFunctionApproximator(Composition):
    ...
    def evaluate(self, state_feature_values, control_allocation, num_estimates, base_context=Context(execution_id=None), context=None):
        ...
        **input**, using current set of `prediction_parameters <FunctionAppproximator.prediction_parameters>`.
        ...
        return self.function(state_feature_values, control_allocation, context=context)
