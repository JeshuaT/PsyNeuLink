...
#     num_features: number of particular state per dimension (e.g. number of colours)
...
# As data we generate random state for all input dimensions. To specify a mapping, we use the rule that input
