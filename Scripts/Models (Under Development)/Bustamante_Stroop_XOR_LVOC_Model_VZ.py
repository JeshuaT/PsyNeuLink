...
lvoc = pnl.OptimizationControlMechanism(
    ...
    state=[color_stim.input_port, word_stim.input_port],
    # state={pnl.SHADOW_EXTERNAL_INPUTS: [color_stim, word_stim]},
    ...
    # evaluate() computes outcome (obj mech) - costs given state (state) and sample ctrl alloc
...
for i in range(num_subj):
    ...
    # print('state: ', lvoc.state_feature_values)
